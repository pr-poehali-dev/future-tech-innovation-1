    ...
    >
      <div className="fixed top-[-10vh] left-0 h-[120vh] w-full">
        <motion.div style={{ y }} className="relative w-full h-full">
          <img
            src="https://cdn.poehali.dev/projects/ffe56454-6a77-47e8-8f74-dd30634aae55/files/0db74c71-5c9f-4e72-810c-6ce91bb6bd1c.jpg"
            alt="AutoTap automation"
      ...
      <p className="absolute bottom-12 right-6 text-white text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-5xl z-10 font-bold leading-tight">
        Забудь о монотонных кликах. AutoTap работает за тебя — пока ты занимаешься настоящими делами.
      </p>
    </div>
  );
}